word_list = [
	...
	"frescura", "lunar", "espiga", "lonja", "genero", "letra", "real", 
	...
	"popular", "porcelana", "portada", "portador", "porcentual",
	...
	"percatar", "rescate", "rescatado", "rescatada", "derrumbar", "derrumbe",
	...
	"lapso", "labrar", "eliptica", "ovalado", "rectilineo", "tonelada", "estrato", 
	...
	"dueño", "dueña", "misma", "enviare","ciudad", "fortaleza", "opera",
	"operar", "operando", "operacion", "maiz", "trigo", "trigueño",
	"trigal", "tragaban", "trague", "trinchera", "corredizo", "rendirse",
	"imposible", "posible", "posibilidad", "positivo", "negativo", "afirmativo",
	"pancreas", "faringe", "laringe", "traquea", "alveolo", "bronquios", 
	"brocoli", "coliflor", "zanahoria", "gris", "plateado", "niebla",
	"clasico", "clasica", "crujiente", "blando", "ablandar", "polea",
	"pandilla", "pandillas", "momentos", "castigaste", "vecino", "vecina",
	"vecindad", "territorios", "territorio", "territorial", "territoriales",
	"bronce", "ceremonia", "ceremonioso", "preparacion", "preparativo", "preparativos",
	"aperitivo", "aperitivos", "apariencia", "aledaño", "adyacente", "ensenada",
	"encina", "despistar", "despistado", "despistada", "despojar", "despojado",
	"despojada", "despojaban", "despoje", "despoblado", "destronar", "destronaban",
	"destronado", "destronada", "destrone", "destronaste", "destrabar", "destrababan",
	"destripar", "destripaban", "destripe", "destripaste", "destrozar", "destrozaste", "destrozo",
	"destrozamos", "destrozan", "destrozaba", "destrozaban", "destrozando", "destripando",
	"destripo", "destripas", "destripa", "destripamos", "destripan", "destriparon", "desvalijar",
	"desvalije", "desvalijaban", "desvalijo", "desvalijas", "desvalijan", "desvalijamos",
	"desvalijes", "despojo", "destorcer", "destrenzar", "destripamiento", "destrenzo",
	"destrenzas", "destrenza", "destrenzamos", "destrenzan", "destrenzabamos", "despuntar",
	"destapar", "desquitar", "desquitando", "desquito", "desquitas", "desquita", "desquitamos",
	"desquitan", "desquitaba", "desquitaban", "desquitabamos", "desquitando", "desprovisto",
	"tarjeta", "distancia", "distanciar", "distante", "distanciado", "cafetera", "cafeteria",
	"cadencia", "cadera", "caderas", "caldera", "candelabro", "cadete", "candiente",
	"cabron", "cacarear", "cacareo", "cacareando", "cacarea", "cadaver", "cadaverico",
	"cachorro", "cachorrito", "cachorra", "cachorrita", "cachivache", "cacharro",
	"caceria", "cacerola", "cacique", "caducidad", "caducar", "cadmio", "caida", "caido",
	"caballito", "cabezazo", "caber", "cabina", "cabeceo", "cabeceas", "cabecea", "cabeceamos",
	"cabeceaba", "cabecean", "cabeceando", "cabizbajo", "cabaña", "cabañas", "palafito",
	"cabezal", "alimentacion", "alimentar", "alimento", "alimenticio", "alimentaba",
	"alimentaran", "alimente", "alimentase", "alimentasemos", "alimentare", "alimentares",
	"alimentaste", "alimentaron", "alineacion", "alentar", "aliento", "alientas", "alienta",
	"alentamos", "alientan", "alentando", "alentara", "alentabamos", "alharaca", "alharaquiento",
	"alharacas", "alguacil", "alguno", "alguna", "algarabia", "garabato", "aleta", "algebra",
	"algarrobo", "alivio", "aletear", "aleteo", "aleteas", "aletea", "aleteamos", "aletean",
	"aleteando", "aleteaban", "alfabeto", "alfabetico", "alfajor", "alfajores", "alfil",
	"torre", "alfa", "alegorico", "algodon", "algodonar", "alias", "alianza", "alicate",
	"aligerar", "alfalfa", "alferez", "baden", "bache", "baches", "badenes", "bacalao",
	"bacteria", "neurona", "axon", "dendrita", "bailarin", "baila", "bailar", "baile",
	"bailan", "bailaste", "bailaban", "bailan", "bailando", "badminton", "babosa",
	"babosear", "baboso", "bachiller", "azucarero", "ayuntamiento", "azar", "azaroso",
	"azufre", "ayuno", "ayunar", "ayune", "ayunes", "azteca", "ayudantia", "azotea",
	"baba", "badajo", "bacteriologia", "babero", "bacilo", "teresa", "almidon",
	"alcaparra", "colorante", "colorido", "colorida", "coloridos", "coloridas",
	"columpio", "columpiar", "columpian", "columpiandose", "columpiaban",
	"columpiando", "colorante", "comezon", "comedia", "colosal", "coma", "comillas",
	"comico", "comica", "comarca", "combatiente", "combate", "colusion", "comadrear",
	"comadreja", "combustion", "comercializar", "comercializacion", "comensal",
	"comisario", "cometa", "meteorito", "comics", "comediante", "cenicero", "celebridad",
	"cementerio", "celta", "cegar", "cedro", "cedula", "cefalea", "cefalopodos",
	"cefalorraquideo", "cenegal", "cenar", "censo", "censura", "censurado", "censurada",
	"censurando", "censuraban", "censure", "celulosa", "celofan", "catalina", "categoria",
	"categorico", "catacumbas", "catapulta", "catarata", "cascada", "cascadas", "cataratas",
	"caviar", "cautivador", "lumbago", "longitudinal", "lujoso", "lujosa", "lujuria",
	"lunatico", "espantar", "espantapajaros", "esparrago", "emparejar", "emparejando",
	"empareja", "emparejaban", "emparejas", "emparejamos", "emparejamiento", "sancochar",
	"salsera", "salpicar", "salpicadura", "samurai", "saltarin", "saltarina", "reprobar",
	"repruebo", "reprobado", "reproducible", "representar", "representado", "representable",
	"resaca", "requeson", "queso", "raptar", "reptar", "represa", "raptan", "reptan",
	"representante", "reprobatorio", "repudio", "repudiar", "requemar", "pordiosear",
	"pordioseo", "porosidad", "porfiado", "porfiar", "porfiada", "porqueria", "porro",
	"portal", "portales", "portaaviones", "pordiosero", "ahumado", "ahumar", "ahumada",
	"cerveza", "contesta", "contestar", "contestador", "testarudo", "tarugo", "contestadora",
	"afonico", "afonica", "conveniencia", "fallece", "fallecer", "fallecido", "falleciendo",
	"fallecio", "fallecen", "reconocida", "reconocido", "aliteracion", "aliñar", "aliño",
	"confusion", "confundido", "sorpresa", "sorprendido", "confundida", "arrinconar",
	"arriesgar", "arriesgo", "arriesgada", "arriesgado", "arriesgaban", "arriesgando",
	"albondiga", "alborotador", "alborotadora", "alboroto", "album",
	"incubar", "incrustar", "incubo", "incubas", "incuba", "incubamos", "incuban",
	"incubando", "incubara", "incubare", "incrustado", "incrustacion", "incrusto", 
	"incrustas", "incrusta", "incrustamos", "incrustan", "incrustando", "disminuir",
	"disminuya", "disminuye", "disminuyo", "disminuimos", "disminuyen", "disminuyendo",
	"ceno", "cenas", "cena", "cenamos", "cenan", "cenando", "cenara", "cenase",
	"comadreando", "comadreo", "comadreas", "comadrea", "comadreamos", "comadrean",
	"indocil", "indocilidad", "indistinto", "incumplimiento", "incumplir", "alejado",
	"inculpado", "inculpar", "indecencia", "indecente", "indeciso", "indefenso",
	"individualidad", "individuo", "ostentoso", "ostentar", "ostentador", "corporacion",
	"indole", "indolencia", "indivisible", "indeterminacion", "indeterminado", "indeseable",
	"indesignable", "indescriptible", "indestructible", "independiente", "indescifrable",
	"independizarse", "indicio", "indigena", "municion", "municipal", "muñeca", "mugre",
	"mugriento", "mueca", "mundano", "multimillonario", "muestreo", "muestra", "plancha",
	"mudanza", "mudar", "neumatico", "garrote", "garrapata", "garrocha", "gangoso",
	"gangosa", "gangrena", "ganancia", "potestad", "potente", "potencial", "semillero",
	"panel", "panera", "loma", "lucidez", "lucido", "interruptor", "interrupcion",
	"interrumpir", "oblea", "preservar", "motel", "desatino", "cuartear", "compostura",
	"compota", "garza", "gangster", "castidad", "castellano", "castrado", "casero",
	"casera", "caspa", "cascabel", "cabalgar", "cabalgata", "discernir", "disciplina",
	"dirigible", "dirigir", "dirijo", "diriges", "dirige", "dirigimos", "dirigen",
	"dirigiendo", "dirigiera", "dirigiese", "dinosaurio", "diodo", "dirigente", 
	"diluvio", "diminutivo", "dinamo", "dineral", "dinero", "paladar", "cerradura",
	"brasero", "desarticular", "paila", "palomilla", "regulacion", "regulado",
	"regular", "mapuche", "vociferaba", "vociferar", "espaciado", "humedo", "alejamiento",
	"diccionario", "ritmo", "yugular", "desatascar", "desatender", "desatinar", "desatasco",
	"destascas", "desatasca", "desatascamos", "desatascan", "desatascando", "desatascara",
	"desatascare", "desatar", "desatado", "desato", "desatas", "desata", "desatamos",
	"desatan", "desatando", "desatara", "desatare", "desataria", "desatento", "desatenta",
	"desacreditar", "desalojar", "desarrugar", "desarropar", "desarreglo", "desarreglar",
	"desahogo", "desahogar", "desahogas", "desahoga", "desahogamos", "desahogan",
	"desahogando", "desahogara", "desahogaria", "desanudar", "desanimo", "desanimas",
	"desanima", "desanimamos", "desaniman", "desanimando", "desanimara", "desanimaria",
	"desanimarias", "desanimariamos", "desanimarian","desanimase", "desafuero",
	"desarticulacion", "saltamontes", "salpullido", "salpicon", "salubre", "salubridad",
	...
	"descarrilamiento", "brutal", "juicio", "reportaje", "reportajes", "bencina",
	"parafina", "bajarian", "bajada", "bajar", "trepar", "trepadora", "trepador",
	"precio", "economista", "permutar", "permutacion", "diesel", "dolar", "podrian",
	"informe", "extremo", "extrema", "extremidad", "clava", "intensifica",
	"transporte", "transportador", "especiales", "especial", "calavera", "encerrado",
	"abucheo", "nueva", "nubosidad", "parcial", "imparcialidad", "imparcial", 
	"decantacion", "decantado", "decantar", "asentar", "asentamiento", "musculoso",
	"musculosa", "indigestion", "indigente", "flan", "flancito", "pamela", "utensilio",
	"uranio", "plutonio", "undecimo", "unicornio", "urbanizacion", "urbano", "urbanizar",
	"urbana", "untar", "urna", "usted", "usura", "uterino", "uterina", "utero",
	"vacilon", "vacilona", "vacilar", "vacilante", "vacilacion", "vacuola",
	"vaguada", "vaina", "valuar", "valija", "vasallo", "vastago", "vaticano", "vegetacion",
	"vecinal", "vastedad", "vasija", "vega", "vecindario", "vehemencia", "vehemente",
	"veintena", "veinte", "vegete", "trofeo", "troglodita", "triseccion", "trillizo",
	"trilliza", "trimestral", "trimestre", "trilogia", "triunfal", "triunfador",
	"triunfante", "triunfo", "trivial", "tristeza", "triste", "triston", "tristona",
	"trivialidad", "triptongo", "tripulacion", "tripulante", "tripular", "tripa",
	"trio", "trinquete", "torniquete", "urico", "vanagloria", "vanguardia", 
	"tamaño", "tamaña", "tamizar", "tamiz", "grabado", "grabar", "grabador", "grabacion",
	"grabadora", "gotear", "grafico", "grafica", "graficos", "graficador", "gramatica",
	"gramatical", "grafito", "gorrion", "mirlo", "tordo", "goteo", "gotica", "gourmet",
	"global", "golpetear", "golpiza", "paliza", "gobernacion", "gobernador",
	"gobernadora", "gobernar", "girasol", "giratorio", "giratoria", "gravitacional",
	"ondulatoria", "nintendo", "secuencia", "gloria", "globulina", "glandula",
	"glandular", "golosina", "glacial", "glaciar", "glaciacion", "gitano", "gitana",
	"gigantezco", "geriatra", "geriatria", "gentileza", "genocidio", "genotipo",
	"gentil", "genio", "genialidad", "gestacion", "genuino", "genuina", "gendarme",
	"gendarmeria", "cuentakilometros", "abarrancar", "agarrotado", "abatible", "abatir",
	"abdomen", "abdominal", "abanderado", "abducir", "abducido", "abduccion", "abductor",
	"abaniqueo", "abanico", "abanicar", "abochornado", "abochornar", "abrevadero",
	"abreviatura", "abreviar", "absoluto", "abreviado", "absolver", "abecedario",
	"abedul", "abstraccion", "aborrecer", "abordar", "abordaje", "abstinencia",
	"abismo", "abismar", "abismal", "abejorro", "abertura", "abeja", "abrazadera",
	"aceituna", "abuelo", "abuela", "acabado", "academia", "accesorio", "acalorado",
	"acampada", "aceitar", "acceso", "acceder", "acantonar", "acantonamiento",
	"acaramelar", "acaramelado", "acaro", "aburrimiento", "aburrida", "aburrirse",
	"accionamiento", "aclimatar", "aclimatado", "acodar", "acodado", "acodada",
	"aclimatable", "aclimatacion", "acetileno", "acetato", "acerca", "acerado",
	"acerada", "acetona", "acierto", "acidificacion", "aclaratorio", "acomodar",
	"acomodate", "acomodando", "acompañante", "acidificar", "acogedora", "acogedor",
	"acomplejar", "acomplejado", "acometida", "acorchar", "acorchado",
	"biblioteca", "quimica", "quimico", "biologia", "integrada", "integrado",
	"antartica", "artico", "atico", "pleural", "semantico", "semantica",
	"expendio", "apogeo", "citara", "inconcluso", "ciempies", "cienaga", "cieno",
	"cicatrizar", "cibernetica", "cicatrizante", "cicatrizacion", "cesped",
	"cesto", "cianuro", "cerrajero", "cerrajeria", "cerrojo", "certificar",
	"certificado", "cerumen", "certificacion", "cetaceo", "cetaceos", "cetro",
	"ciclon", "cervical", "cerviz", "cerveceria", "cernir", "centolla", "cerda",
	"centralizar", "centrado", "central", "centella", "centesimal", "centesimo",
	"centenario", "centelleante", "centelleo", "centavo", "centrifugar", "centrifugadora",
	"centrifugado", "centrifugacion", "centuria", "centurion", "centrico", "ceniza",
	"hidrocefalea", "cenagoso", "cenagal", "celada", "cebrado", "cebiche", "cebo",
	"cebra", "cavilacion", "catalogo", "catalogar", "catalogacion", "catalizar",
	"catalizador", "anodo", "catodo", "catar", "catarsis", "cataplasma",
	"catalan", "cavilar", "cavernicola", "catear", "cateador", "cateo", 
	"catedra", "catedral", "catastro", "catastrofe", "catastrofico", "cauteloso",
	"cautela", "cauterizacion", "cauterizar", "psicologia", "psicologo",
	"psicologa", "psicologico", "psicologica", "psicologos", "psicologas",
	"psiquiatra", "psiquiatria", "psiquiatras", "psiquis", "psicosis",
	"neurosis", "tumor", "benigno", "maligno", "tumoral", "catalepsia",
	"epilepsia", "catalejo", "cazadora", "cazador", "caza", "cayo", "cavernoso",
	"cavernosidad", "catequesis", "cateter", "caverna", "cauto", "cauta", 
	"caudaloso", "catecismo", "catabolismo", "castrar", "cascara", "cascaron",
	"cascarrabias", "caseta", "casamentero", "casamentera", "casillero",
	"casete", "casaca", "carton", "cartel", "carnaval", "carnavales", "carteles",
	"carpintero", "carpinteria", "carraspear", "carraspeo", "carretera",
	"carroceria", "carnada", "carmin", "carmesi", "carnero", "carniceria",
	"carnicero", "carnicera", "cariar", "carbonato", "carencia", "cardiovascular",
	"carcelero", "careta", "caracola", "capsula", "capitana", "capitan", 
	"capitanear", "caprichoso", "caprichosa", "captacion", "captar", "capto",
	"captaba", "captaban", "capte", "captaria", "captes", "captamos", "captan",
	"captase", "captare", "capitolio", "percance", "capitulo", "capitular",
	"canibal", "canibalismo", "candidato", "candidatura", "candil", "fraguar",
	"canicas", "canje", "canjeable", "canjear", "cantante", "candente", "mandarin",
	"canilla", "canillas", "canino", "candor", "candoroso", "canuto",
	"cañon", "encañonar", "caño", "cañaveral", "cañeria", "cañonazo", "montan",
	"tronan", "estruendo", "colmar", "colmado", "colmada", "roma", "romano",
	"germano", "germinar", "enfilar", "interconectar", "permanente", "permanecer",
	"permanezca", "permanezco", "permaneces", "permanece", "permanecemos", "permanecen",
	"permanecia", "permanecian", "permaneciendo", "estupro", "moza", "mozo",
	"moscardon", "movilizar", "movilizacion", "inmovilidad", "inmovil", "emotivo",
	"mucama", "mucamo", "morse", "montura", "moluscos", "modesto", "modesta",
	"modestia", "modismo", "modular", "modulacion", "modulada", "modulo",
	"generalizado", "egocentrismo", "egocentrico", "somnifero", "somnolencia",
	"moderno", "modernidad", "modernismo", "moderna", "reactivo", "explosion",
	"implosion", "arte", "artistico", "artistica", "artista", "baleada", "balacera",
	"contenidos", "enrrollado", "arrollado", "arrollar", "colision", "repeler",
	"repelio", "repelido", "repelen", "vociferaban", "espeto", "linterna", "fiambre", 
	"repertorio", "despensa", "alacena", "bendito", "bendita", "tijereta", "cumplido",
	"complemento", "complementar", "condimentar", "balbuceo", "balbucear", "espejismo",
	"relatividad", "labrada", "labrado", "asistencia", "estancia", "estandante", "estandarte",
	"estandarizado", "esturion", "paralizado", "paralisis", "remora", "remo", "remos", "remar",
	"tiña", "teñir", "teñido", "teñida", "trazo", "trazar", "trazado", "trazada", "holograma",
	"ilusion", "ilusorio", "oportunidad", "oportunismo", "oportuno", "oportuna", "zapallo", 
	"pistacho", "sesamo", "cañamo", "busqueda", "buscar", "buscando", "busque", "buscaria",
	"buscan", "buscado", "buscador", "busquemos", "buscariamos", "buscarian", "buscaba",
	"fonetica", "idioma", "jerga", "buscase", "lexico", "morfologia", "neologismo",
	"ortografia", "ortografico", "pronunciacion", "sinonimo", "traduccion", "uso", "usar",
	"usas", "usa", "usamos", "usan", "usando", "usaba", "usaban", "usaria", "usare", "usase",
	"zambullir", "zambullida", "adverbio", "boligrafo", "cognado", "derivacion", "etimologia",
	"glosario", "hiperbaton", "infinitivo", "metafora", "onomatopeya", "quimera", "horda",
	"guisado", "guiso", "habitat", "habladuria", "hebilla", "hacinamiento", "hazaña", 
	"halito", "haragan", "hectometro", "hartar", "hedonista", "puritano", "vanidad",
	"vanidoso", "vanidosa", "tematico", "bilingue", "conjugacion", "diacritico", "elocucion",
	"gerundio", "heteronimo", "lexema", "nexo", "sintagma", "tautologia", "activa",
	"wolframio", "xenofobia", "yincana", "zambomba", "yuxtaposicion", "participio",
	"nominativo", "oracion", "sujeto", "predicado", "mimica", "biografia", "conjuncio",
	"diptongo", "enunciado", "grafema", "interseccion", "interjeccion", "tilde",
	"tonica", "sufijo", "quesadilla", "ortoepia", "monosilabo", "interrogativo",
	"entonacion", "entonado", "entonada", "barroco", "dieresis", "bilabial",
	"aforismo", "copulativo", "dialecto", "estilistica", "fonologia", "oratoria",
	"quilometro", "toponimo", "palindromo", "xilofono", "sinecdoque", "paragrafo",
	"hieroglifico", "enlace", "axioma", "reiterado", "reiterada"]